              ...
              children: [
                ...
                Row(
                  ...
                  children: [
                    ...
                    Text(
                      '${DateFormat.yMd(draw == false ? 'en' : 'ar').format(followComplaints.date!.toDate())} ',
  ...
  _getBGClr(int? color) {
    switch (color) {
      ...
      case 2:
        return Colors.amber;
      case 3:
        return followComplaints.competent == 'AntiCyberCrimesUnit' ||
                followComplaints.competent == 'MinistryofCommunications'
            ? Colors.green
            : Colors.amber;
      default:
        return Colors.green;

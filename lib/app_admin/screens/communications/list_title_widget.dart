...
class ListCommunicationsWidget extends StatelessWidget {
  const ListCommunicationsWidget({super.key, required this.eventModel});

  final CommunicationsModel eventModel;
